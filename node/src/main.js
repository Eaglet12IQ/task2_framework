...
import { loadModulesFromConfig, buildOrder, CONTRACT_VERSION } from "./moduleLoader.js";
...
console.log(`Версия контракта модулей: ${CONTRACT_VERSION}`);
console.log("");

const all = await loadModulesFromConfig(configPath, modulesDir, externalModulesDir);
